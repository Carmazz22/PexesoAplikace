...
namespace PexesoAplikaceWF
{
    public partial class Game_Singleplayer : Form
    {
        ...
        private void InicilizujBocniPanel()
        {
            ...
            labelObtiznost.Text = "Obtížnost AI: " + nastaveniObtiznosti;
            labelObtiznost.Location = new Point(0, 450);
            labelObtiznost.Size = new Size(240, 30);
            labelObtiznost.Font = new Font("Segoe UI", 10, FontStyle.Italic);
            labelObtiznost.TextAlign = ContentAlignment.MiddleCenter;
            labelObtiznost.ForeColor = Color.Gray;
